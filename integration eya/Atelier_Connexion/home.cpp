...
QString path="C:/Users/EYA/Desktop/integration eya/12.WAV";
...
vw->setGeometry(11,11,300,150);
player->setVideoOutput(vw);
QString pathVideo="C:/Users/EYA/Desktop/integration eya/coffeepub.mp4";
...
{
    {
            QSqlQueryModel * model= new QSqlQueryModel();
                             model->setQuery("select * from G_PERSONNELS where AGE < 18 ");
                             float code=model->rowCount();
                             model->setQuery("select * from G_PERSONNELS where AGE  between 18 and 50 ");
                             float codee=model->rowCount();
                             model->setQuery("select * from G_PERSONNELS where AGE >50 ");
...
void home::on_supprimer_keyperso_btn_2()
{
    //supprimer_keyperso
    Employe e1;
...
void home::on_chercher_modifier_3_clicked()
{
    Employe e1;
...
void home::on_pb_modifier_8_clicked()
{Notification n;
...
Employe e(nom,keyperso,prenom,pass,age);
  ...
  {int test1=m1.modifier(keyperso,nom,prenom,pass,age);
     ...
     ui->tab_chercher_2->setModel(em.afficher(-1,this->order));
      ...
      {
          QMessageBox::critical(nullptr, QObject::tr("Supprimer un G_PERSONNELS"),
                      QObject::tr("Erreur !.\n"
                                  "Click Cancel to exit."), QMessageBox::Cancel);
...
void home::on_marketing_clicked()
{
